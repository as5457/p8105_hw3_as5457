...
<img src="p8105_hw3_as5457_files/figure-markdown_github/unnamed-chunk-17-1.png" width="90%" />
...
hex = ny_weather %>% 
  ...
  geom_hex() +
  labs(
    title = "New York Hexagon Plot of Maximum Temperature vs. Minimum Temperature",
...
``` r
grid.arrange(hex, snowfall, ncol = 1)
```
